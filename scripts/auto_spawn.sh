...
# DISABLED: + marker / landing_marker.png interferes with YOLO-OBB-only test
# spawn_model "REP rescue marker" "$MODEL_ROOT/land_marker/model.sdf" "land_marker_rep" "$REP_X" "$REP_Y" "0.02"
