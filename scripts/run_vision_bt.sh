...
echo "[vision_bt] model=${VISION_MODEL_PATH} image_topic=${ROS_IMAGE_TOPIC:-/image_raw} initial_target=${YOLO_INITIAL_TARGET} obb_confidence=${VISION_OBB_CONFIDENCE} tracking_hold_sec=${VISION_TRACKING_HOLD_SEC} inference_interval_sec=${VISION_INFERENCE_INTERVAL_SEC}"
